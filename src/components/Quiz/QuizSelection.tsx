...
const quizChapters: QuizChapter[] = [
  {
    ...
    description: "Kiểm tra kiến thức về đại đoàn kết toàn dân tộc trong tư tưởng Hồ Chí Minh thông qua các câu hỏi đa dạng",
    parts: 10,
  ...
  },
  {
    ...
    description: "Tìm hiểu về vai trò và nguyên tắc hoạt động của Mặt trận dân tộc thống nhất",
    parts: 8,
  ...
  },
  {
    ...
    description: "Khám phá tư tưởng đoàn kết quốc tế và sự ủng hộ của bạn bè thế giới",
    parts: 6,
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-6xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-500 mb-4" style={{ fontFamily: 'cursive' }}>
            Quiz
          </h1>
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  Kiểm tra kiến thức về các điều kiện cần thiết để xây dựng khối đại đoàn kết toàn dân tộc trong tư tưởng Hồ Chí Minh thông qua các câu hỏi đa dạng
                </p>
