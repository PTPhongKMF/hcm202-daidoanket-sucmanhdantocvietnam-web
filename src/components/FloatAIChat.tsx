          ...
          <ScrollArea viewportRef={viewportRef}
            ...
            <div className="h-full w-full grid auto-rows-auto gap-2">
              ...
              <div className="flex justify-start items-start gap-1 pe-2">
                ...
                <div className="text-xs rounded-lg p-2 bg-slate-200 mt-1">
                    ...
                    return (
                      <div key={index} className="flex justify-start items-start gap-1 pe-16">
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="text-xs rounded-lg p-2 bg-slate-200 mt-1 prose break-words">
                            <ReactMarkdown>
                              {msg.msg}
                            </ReactMarkdown>
                          </div>
              ...
              {aiChat.isPending && (
                <div className="flex justify-start items-start gap-1 pe-2">
                  <img src="/imgs/avatar/vietnamball.png" alt="Bot Image" className="size-10 rounded-full object-cover border-2 border-gray-300" />
                  <div className="text-xs rounded-lg p-2 bg-slate-200 mt-1 flex justify-between items-center gap-4">
                    Xíu nhen
