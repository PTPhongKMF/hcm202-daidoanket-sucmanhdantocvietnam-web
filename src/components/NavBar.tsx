  ...
  return (
    ...
    >
      <Link to="/" className="flex gap-4 items-center justify-self-start">
        ...
        <h1 className="text-xl font-semibold text-black/10 group-hover:text-black hover:text-red-700 transition-colors duration-100">Đại Đoàn Kết</h1>
      </Link>
      <div className="flex gap-8 items-center justify-self-end">
        <Link to="/quiz">
          <p className="font-semibold text-black/10 group-hover:text-black hover:text-red-700 transition-colors duration-100">Quiz</p>
        </Link>
        
        <Link to="/sources">
          <p className="font-semibold text-black/10 group-hover:text-black hover:text-red-700 transition-colors duration-100">Nguồn</p>
        </Link>
